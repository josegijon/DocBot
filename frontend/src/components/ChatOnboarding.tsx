...
export const ChatOnboarding = ({ filename }: ChatOnboardingProps) => {
    return (
        <div className="flex-1 flex flex-col items-center justify-center relative h-full">
            ...
            <div className="max-w-3xl w-full flex flex-col items-center gap-3 text-center z-10">
                ...
                <p className="font-geist text-body-lg text-on-surface-variant max-w-lg">
                    La IA ya ha analizado la estructura del documento. Haz una pregunta sobre el contenido para comenzar la conversación.
                </p>
            </div>
        </div>
    )
