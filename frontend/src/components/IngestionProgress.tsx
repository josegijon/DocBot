...
export const IngestionProgress = ({ progress, status, filename }: IngestionProgressProps) => {
    ...
    return (
        <div data-testid="ingestion-progress-container" className="flex flex-col gap-6 pt-6">
            <div className="flex justify-between items-end">
                <div className="flex flex-col gap-2">
                    <span
                        data-testid="ingestion-progress-status-text"
                        className={`font-jetbrains text-label-md flex items-center gap-2 ${isFailed ? "text-error" : "text-primary"}`}
                    >
                ...
                <span data-testid="ingestion-progress-percentage" className="font-jetbrains text-code-sm text-primary">
                    {progress}%
                </span>
            </div>
